...
{
    string wordOne = string(word1);
    std::transform(wordOne.begin(), wordOne.end(), wordOne.begin(), ::toupper);
    string wordTwo = string(word2);
    std::transform(wordTwo.begin(), wordTwo.end(), wordTwo.begin(), ::toupper);
    //vector<string> pron1 = dict.at(wordOne);
    std::map<std::string, std::vector<std::string>>::const_iterator it1 = dict.find(wordOne);
    std::map<std::string, std::vector<std::string>>::const_iterator it2 = dict.find(wordTwo);
