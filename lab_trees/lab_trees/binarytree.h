...
class BinaryTree
{
    public:
        ...
        bool recursiveHelper(Node * root) const;

        T leftMax(Node * subroot) const;

        T rightMin(Node * subroot) const;
        ...
        /**
         * Helper function that I made
         */
         void addToVector(Node * node, std::vector<std::vector<T> > & pathsVect, std::vector<int> intVect) const;
    ...
    private:
        ...
        int distRecursive(Node * subroot, int layer) const;
